...
//        String date = DateUtils.secondToDate(serviceMessageList.getRelease_time(), "yyyy-MM-dd HH:mm");
        ...
        if (holder instanceof QuestionReplyViewHolder) {
            ...
            gameDetailHolder.iv_sign.resize(200, 200);
                ...
                for (int i = 1; i < content_lists.size(); i++) {
                    ...
                    switch (i) {
                        case 1:
                            ...
                            gameDetailHolder.iv_article1.resize(200, 200);
                        ...
                        case 2:
                            ...
                            gameDetailHolder.iv_article2.resize(200, 200);
                        ...
                        case 3:
                            ...
                            gameDetailHolder.iv_article3.resize(200, 200);
                        ...
                        case 4:
                            ...
                            gameDetailHolder.iv_article4.resize(200, 200);
...
//        ImageDraweeView question_item_ask_icon_text;
     ...
     * 加载数据
     */
    private void initServiceQuiz(final QuestionLocalViewHolder questionLocalViewHolder, final ServiceMessageList serviceMessageList, final String msg, final int position, final int type) {
        NetworkUtil.getInstance().startRequest(CompanionApi.sendServiceQuiz(mServiceId, msg, type),

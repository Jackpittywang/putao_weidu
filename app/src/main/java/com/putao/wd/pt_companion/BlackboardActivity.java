...
//                ptl_refresh.refreshComplete();
//
//                ArrayList<CompanionBlackboard> reLists = new ArrayList<CompanionBlackboard>();
//
//
//
////                reLists.add(new CompanionBlackboard("话题", "1234123134", "0", "话题话题", "聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊", 200, 1, 1, "1月12日-12月12日"));
////                reLists.add(new CompanionBlackboard("文章", "1234123134", "0", "话题话题", "聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊聊", 300, 1, 1, "1月12日-12月12日"));
////                reLists.add(new CompanionBlackboard("创意", "2234123134", "0", "话题话题", "聊聊聊聊聊聊聊聊聊", 533, 1, 1, "1月12日-12月12日"));
//
//                mBlackboardActivityAdapter.replaceAll(reLists);
//
//                ptl_refresh.setVisibility(View.VISIBLE);
//
//                ptl_refresh.refreshComplete();
//
//                //checkLoadMoreComplete(result.currentPage(),totalPage);
//
//                loading.dismiss();
//               // getDiaryIndex();
//            }

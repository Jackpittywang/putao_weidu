 ...
 */
public class GameStepListAdapter extends BasicAdapter<GameList, GameStepListAdapter.GameListHolder> {
    ...
    @Override
    public GameStepListAdapter.GameListHolder getViewHolder(View itemView, int viewType) {
        return new GameListHolder(itemView);
    }

    @Override
    public void onBindItem(final GameStepListAdapter.GameListHolder holder, final GameList companion, final int position) {

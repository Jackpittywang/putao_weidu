 ...
 */
@Deprecated
public class PutaoCompanionFragment2 extends BasicFragment implements View.OnClickListener, OnItemClickListener<DiaryApp> {
    ...
    protected int getLayoutId() {
        return R.layout.fragment_companion1;
    }

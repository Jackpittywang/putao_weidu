...
import com.putao.wd.db.db.ShippingAddressDBManager;
import com.putao.wd.db.entity.ShippingAddressDB;
import com.putao.wd.me.adapter.AddressAdapter;
...
public class AddressListFragment extends PTWDFragment<GlobalApplication> implements View.OnClickListener {
    ...
    private List<ShippingAddressDB> addresses;
    ...
    public void onViewCreatedFinish(Bundle savedInstanceState) {
        addNavgation();
        addresses = ShippingAddressDBManager.getInstance(mApp).loadAll();

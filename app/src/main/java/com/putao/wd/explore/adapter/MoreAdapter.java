 ...
 */
public class MoreAdapter extends BasicAdapter<HomeExploreMore, ExploreMoreAdapter.MoreViewHolder> {
    ...
    @Override
    public void onBindItem(ExploreMoreAdapter.MoreViewHolder holder, HomeExploreMore homeExploreMore, int position) {

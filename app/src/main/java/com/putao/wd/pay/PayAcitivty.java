 ...
 */
@Deprecated
public class PayAcitivty extends BasicFragmentActivity implements View.OnClickListener {
    // 商户PID
    ...
    public String getOrderInfo(String subject, String body, String price) {
        return "_input_charset=utf-8&" +
                ...
                "total_fee=0.03&" +
                "sign=lC%2FJk6mv%2F3AWWyon2wxHvAaLRftnraOEmQLLwsokFRfflhKDjnJWAw%2BlaateNBntTe0XUyCc6i4fA%2FH79ByJ2dluJiYR%2F5aH8c%2BprIpCqxGzanDDrtchgAK0QcQsMIXbOaItBWFf%2FCF3XZQqC7UTVA1pubEKY2fCp8q7UXtnNqo%3D&sign_type=RSA";
//        // 签约合作者身份ID
...
//                }
                ...
                payThread.start();
                break;
            case R.id.check://查询终端设备是否存在支付宝认证账户

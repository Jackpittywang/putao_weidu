                ...
                new AlertDialog.Builder(mContext).setTitle("年龄").setIcon(
                        ...
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                switch (which) {
                                    case 0:
                                        tv_parent_relation.setText("爷爷");
                                        break;
                                    case 1:
                                        tv_parent_relation.setText("奶奶");
                                        break;
                                    case 2:
                                        tv_parent_relation.setText("外公");
                                        break;
                                    case 3:
                                        tv_parent_relation.setText("外婆");
                                        break;
                                    case 4:
                                        tv_parent_relation.setText("爸爸");
                                        break;
                                    case 5:
                                        tv_parent_relation.setText("妈妈");
                                        break;
                                    case 6:
                                        tv_parent_relation.setText("叔叔");
                                        break;
                                    case 7:
                                        tv_parent_relation.setText("阿姨");
                                        break;
                                    case 8:
                                        tv_parent_relation.setText("舅舅");
                                        break;
                                    case 9:
                                        tv_parent_relation.setText("舅妈");
                                        break;
                                    case 10:
                                        tv_parent_relation.setText("姑姑");
                                        break;
                                    case 11:
                                        tv_parent_relation.setText("姑爹");
                                        break;
                                }
                                dialog.dismiss();
                            }
                ...
                new AlertDialog.Builder(mContext).setTitle("年龄").setIcon(
                        ...
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                switch (which) {
                                    case 0:
                                        tv_childage.setText("1岁");
                                        break;
                                    case 1:
                                        tv_childage.setText("2岁");
                                        break;
                                    case 2:
                                        tv_childage.setText("3岁");
                                        break;
                                    case 3:
                                        tv_childage.setText("4岁");
                                        break;
                                    case 4:
                                        tv_childage.setText("5岁");
                                        break;
                                    case 5:
                                        tv_childage.setText("6岁");
                                        break;
                                    case 6:
                                        tv_childage.setText("7岁");
                                        break;
                                    case 7:
                                        tv_childage.setText("8岁");
                                        break;
                                    case 8:
                                        tv_childage.setText("9岁");
                                        break;
                                    case 9:
                                        tv_childage.setText("10岁");
                                        break;
                                    case 10:
                                        tv_childage.setText("11岁");
                                        break;
                                    case 11:
                                        tv_childage.setText("12岁");
                                        break;
                                }
                                dialog.dismiss();
                            }

...
public class ExploreApi {
    ...
    private static final String BASE_URL = GlobalApplication.isDebug ? "api-weidu.ptdev.cn/" : "http://api-weidu.putao.com/";//基础url
    private static final String COMPANION_URL = GlobalApplication.isDebug ? "api-weidu.ptdev.cn/" : "http://api-weidu.putao.com/";//基础url
